...
<style>
 ...
 <div class="card">
    <div class="card-header">
      <h3 class="card-title">REGISTRAR OCURRENCIA</h3>
    </div>
    <div class="alert  hidden" role="alert"></div>
    <form method="POST" action="{{ route('ocurrencia.update',$ocurrencia->id)}}" id="form">
        @csrf @method('put')
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <h5>Descripcion :</h5>
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="" cols="50" rows="3" placeholder="Ingrese Descripcion ...">{{$ocurrencia->descripcion}}</textarea>
                    @error('descripcion')
            ...
            <div class="col-md-12 text-center" style="margin-top: 40px">
                <div class="form-group">
                    ...
                    <a href="{{route('cancelarOcurrencia')}}" class='btn btn-danger'><i class='fas fa-ban'></i> Cancelar</a>              
                </div> 
            </div>
        </div>
    </form>
