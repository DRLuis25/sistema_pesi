...
<style>
 ...
 <div class="card">
    <div class="card-header">
      <h3 class="card-title">EDITAR JUSTIFICACION DE FALTA</h3>
    </div>
    <div class="alert  hidden" role="alert"></div>
    <form method="POST" action="{{ route('justificacionfalta.update',$falta->id)}}" id="form">
        @csrf @method('put')
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-3">
                    <h5>Descripcion :</h5>
                    <textarea class="form-control @error('descripcion') is-invalid @enderror" name="descripcion" id="" rows="3" placeholder="Ingrese Descripcion ...">{{$falta->descripcion}}</textarea>
                </div>
                @error('descripcion')
